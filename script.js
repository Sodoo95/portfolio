...
const projects = [
  ...
  },
  {
    ...
    gif: 'BoidSim.gif',
    desc: 'Pushed my ECS knowledge further — larger flocks, richer interactions, and tighter performance on top of the original 2D boids.',
    language: 'C++',
  ...
  },
  {
    ...
    gif: 'SFML_Boid1.gif',
    desc: '2D boids built with SFML — first real dive into Entity Component System architecture.',
    language: 'C++',
    tags: ['SFML', 'ECS', 'Boids'],
    stars: 0,
  },
